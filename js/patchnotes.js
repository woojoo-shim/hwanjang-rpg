/* ════════════ 패치노트 시스템 ════════════ */
var PATCH_VERSION='1.7.0';
var PATCH_DATE='2026-04-19';
var PATCH_NOTES=[
  {cat:'🆕 v1.7.0 신규',items:[
    '♂♀ 성별 선택 — 캐릭터 생성 시 남자/여자 선택 (체형/머리 다름)',
    '🎨 인벤토리 캐릭터 미리보기 — 마인크래프트 스타일 3D 모델 + 마우스 휠 줌 + 드래그 회전',
    '🛡️ 갑옷/헬멧/장갑/부츠 시각화 — 장착 시 캐릭터에 보임',
    '⚔️ 무기 모델 대폭 업그레이드 — 등급별 색상 + 글로우, 다중 파츠 (검/도끼/활/지팡이)',
    '✨ 검 잔상 효과 — 공격 시 빛나는 호 + 무기 등급별 색상',
    '🤺 3타 콤보 공격 — 가로 베기 R→L, L→R, 내려치기 + 큰 스윙',
    '🔦 전방 공격 범위 — 360°에서 전방 120° 부채꼴로 (뒤 공격 불가)',
    '💥 허공 베기 — 적 없어도 스윙 애니메이션 + 사운드 재생',
    '🎥 V키 카메라 전환 — 자유 회전 / 등 뒤 고정 모드',
    '💖 마크 RPG 스타일 HUD — 하트 HP, 포션 MP, XP바, 골드, ATK, DEF'
  ]},
  {cat:'⚙️ v1.7.0 개선',items:[
    '🦾 인체 비율 수정 — 팔 길이 단축, 손이 골반 높이에 위치',
    '⚔️ 전투 자세 — 무기 장착 시 자연스러운 포즈',
    '💾 DB에 성별/호감도/방문기록/내구도 저장'
  ]},
  {cat:'🆕 v1.6.0',items:[
