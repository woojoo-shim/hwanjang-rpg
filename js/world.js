...
function mkStonePath(parent){
  ...
  /* 마을 게이트 → 다리(x=-200,z=-350) → 중앙 교차로 (0,0) */
  drawPath([[-350,-450],[-330,-440],[-310,-420],[-280,-400],[-250,-380],[-230,-360]],5,4);
  /* 다리 이후 → 중앙 */
  drawPath([[-180,-350],[-150,-320],[-120,-280],[-90,-220],[-60,-150],[-30,-80],[0,0]],5,4);

  /* 마을 → 다리(x=-200,z=-250) 북쪽 루트 */
  drawPath([[-350,-302],[-320,-290],[-280,-270],[-250,-260],[-230,-250]],4,3);
  drawPath([[-180,-250],[-150,-230],[-120,-200],[-80,-160],[-40,-100],[0,0]],4,3);
