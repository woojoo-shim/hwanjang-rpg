...
var ITEM_POOL=[
  ...
  // ─ 추가 무기: Common ─
  {id:'wood_sword',     name:'나무 검',          icon:'sword', type:'weapon',  rarity:'common',   desc:'그냥 나무를 깎아서 만든 검. 그래도 안 아프지는 않다.',  stats:{공격력:4,내구도:20},  reqLevel:1, durability:20, bonuses:[],                                    flavor:'길가에서 주운 나뭇가지. 쥐면 뭔가 될 것 같다.'},
  {id:'rusty_dagger',   name:'녹슨 단검',        icon:'dagger',type:'weapon',  rarity:'common',   desc:'녹이 잔뜩 슨 단검. 파상풍이 걱정된다.',              stats:{공격력:5,공격속도:10}, reqLevel:1, durability:15, bonuses:['+3% 독 피해'],                       flavor:'누군가 버린 단검. 녹을 벗기면 쓸만할지도 모른다.'},
  {id:'old_club',       name:'낡은 몽둥이',      icon:'hammer',type:'weapon',  rarity:'common',   desc:'어딘가에서 줍온 몽둥이. 의외로 묵직하다.',            stats:{공격력:6,힘요구치:5},  reqLevel:1, durability:30, bonuses:[],                                    flavor:'두께만큼은 자신있다. 구멍 뚫린 양철 통이 박혀있다.'},
  {id:'stone_axe',      name:'돌 도끼',          icon:'axe',   type:'weapon',  rarity:'common',   desc:'석기시대 전사의 로망. 돌로 만든 도끼.',               stats:{공격력:7,공격속도:-5}, reqLevel:1, durability:25, bonuses:[],                                    flavor:'선사시대 무기. 투박하지만 확실하게 부순다.'},
  {id:'bamboo_bow',     name:'나무 활',          icon:'bow',   type:'weapon',  rarity:'common',   desc:'할아버지가 직접 깎아준 나무 활. 정이 넘친다.',        stats:{공격력:5,사거리:8},    reqLevel:1, durability:20, bonuses:[],                                    flavor:'손때가 묻은 나무 활. 할아버지 말로는 30년 전 활이라고.'},
  {id:'bamboo_spear',   name:'대나무 창',        icon:'spear', type:'weapon',  rarity:'common',   desc:'마디가 고스란히 남아있는 대나무 창. 삐걱인다.',       stats:{공격력:6,관통력:5},    reqLevel:1, durability:18, bonuses:[],                                    flavor:'죽림에서 직접 잘라왔다. 관절 마디가 특이한 질감을 만든다.'},
  // ─ 추가 무기: Uncommon ─
  {id:'copper_sword',   name:'구리 검',          icon:'sword', type:'weapon',  rarity:'uncommon', desc:'구리의 광택이 빛나는 견고한 검.',                    stats:{공격력:12,내구도:50,힘요구치:10},       reqLevel:4,  durability:50, bonuses:['+5% 금속 방어구 관통'],              flavor:'구리 특유의 따뜻한 빛이 검신을 따라 흐른다.'},
  {id:'iron_dagger',    name:'철 단검',          icon:'dagger',type:'weapon',  rarity:'uncommon', desc:'날카롭게 벼린 철제 단검. 빠른 공격에 최적화.',        stats:{공격력:10,공격속도:15,민첩요구치:12},  reqLevel:4,  durability:40, bonuses:['+8% 치명타 확률'],                   flavor:'쐐기 모양의 단검. 급소를 노리는 데 특화되어 있다.'},
  {id:'bronze_axe',     name:'청동 도끼',        icon:'axe',   type:'weapon',  rarity:'uncommon', desc:'청동 합금으로 주조한 도끼. 꽤 균형 잡혔다.',          stats:{공격력:14,공격속도:-3,힘요구치:15},     reqLevel:5,  durability:55, bonuses:['+10% 방어구 무시'],                  flavor:'주조 과정에서 생긴 무늬가 날에 새겨져 있다.'},
  {id:'copper_bow',     name:'구리 활',          icon:'bow',   type:'weapon',  rarity:'uncommon', desc:'구리 장식이 달린 강화 활. 사거리가 늘어났다.',        stats:{공격력:11,사거리:12,민첩요구치:10},     reqLevel:4,  durability:38, bonuses:['+5% 이동속도'],                      flavor:'구리 배율경이 부착된 사냥 전용 활이다.'},
  {id:'iron_spear',     name:'쇠 창',            icon:'spear', type:'weapon',  rarity:'uncommon', desc:'단단한 쇳대로 만든 창. 돌격에 제격.',                stats:{공격력:13,관통력:8,이동속도:3},         reqLevel:5,  durability:52, bonuses:['돌격 피해 +12%'],                    flavor:'뾰족한 창끝이 무겁다. 그래도 찌르는 맛이 있다.'},
  {id:'wood_staff',     name:'나무 지팡이',      icon:'staff', type:'weapon',  rarity:'uncommon', desc:'마법사 견습생이 처음 받는 지팡이. 마력을 조금 담는다.',stats:{공격력:9,마나훔치기:3,내구도:45},       reqLevel:3,  durability:45, bonuses:['마나 흡수 +3%'],                     flavor:'가장 기본적인 마법 매개체. 오래 쓰면 마력이 스민다.'},
  // ─ 추가 무기: Rare ─
  {id:'steel_sword',    name:'강철 검',          icon:'sword', type:'weapon',  rarity:'rare',     desc:'정제된 강철로 만든 검. 전장에서 검증된 무기.',        stats:{공격력:22,크리확률:5,내구도:90,힘요구치:20},       reqLevel:10, durability:90, bonuses:['+5% 치명타 확률','적 처치 시 HP +3 회복'],    flavor:'백 번의 전투에서 살아남은 병사의 검이다.'},
  {id:'assassin_dagger',name:'암살자 단검',      icon:'dagger',type:'weapon',  rarity:'rare',     desc:'어둠 속에서 한 번의 일격으로 결판낸다.',              stats:{공격력:18,공격속도:20,크리확률:12,민첩요구치:25},  reqLevel:12, durability:65, bonuses:['은신 중 공격력 +30%','치명타 시 독 부여'],    flavor:'날에 신경독이 발라져 있다. 다루는 자를 가린다.'},
  {id:'knight_axe',     name:'기사의 도끼',      icon:'axe',   type:'weapon',  rarity:'rare',     desc:'기사단이 수여하는 격식 있는 전투 도끼.',              stats:{공격력:26,크리데미지:30,힘요구치:28,내구도:85},    reqLevel:14, durability:85, bonuses:['+30% 치명타 피해','기사 직업 전용 효과'],     flavor:'왕국 기사단의 인장이 새겨진 전투 도끼다.'},
  {id:'longbow',        name:'장궁',             icon:'bow',   type:'weapon',  rarity:'rare',     desc:'전장을 지배하는 긴 활. 사거리가 압도적이다.',         stats:{공격력:20,사거리:20,크리확률:8,민첩요구치:22},     reqLevel:11, durability:70, bonuses:['+20% 원거리 사거리','치명타 화살 관통'],       flavor:'활시위를 당기면 세상이 좁아 보인다.'},
  {id:'silver_spear',   name:'은빛 창',          icon:'spear', type:'weapon',  rarity:'rare',     desc:'은으로 도금한 창촉. 어둠의 존재에게 더 잘 통한다.',  stats:{공격력:24,관통력:15,냉기데미지:8,내구도:75},       reqLevel:13, durability:75, bonuses:['언데드/악마에 +50% 피해','냉기 피해 추가'],    flavor:'순은으로 도금한 창촉은 달빛 아래 차갑게 빛난다.'},
  {id:'mage_staff',     name:'마법사 지팡이',    icon:'staff', type:'weapon',  rarity:'rare',     desc:'마법진이 새겨진 지팡이. 마력의 흐름이 느껴진다.',    stats:{공격력:17,화염데미지:12,마나훔치기:5,내구도:65},   reqLevel:10, durability:65, bonuses:['+12% 화염 마법 강화','마나 흡수 +5%'],         flavor:'마법사 학교 졸업식 때 지급된다. 마력이 잘 전달된다.'},
  {id:'greatsword',     name:'쌍수 대검',        icon:'sword', type:'weapon',  rarity:'rare',     desc:'양손으로 들어야 하는 거대한 검. 한 방이 다르다.',    stats:{공격력:32,크리데미지:40,공격속도:-10,힘요구치:35}, reqLevel:15, durability:100, bonuses:['+40% 치명타 피해','광역 공격 시 관통'],        flavor:'평범한 성인 남성은 들어올리기도 힘들다.'},
  {id:'chain_flail',    name:'쇠사슬 도리깨',    icon:'hammer',type:'weapon',  rarity:'rare',     desc:'철구가 달린 쇠사슬 도리깨. 방어구를 무시한다.',      stats:{공격력:28,관통력:12,이동속도:-5,힘요구치:30},      reqLevel:14, durability:80, bonuses:['+12% 방어 무시','기절 부여 확률 +10%'],        flavor:'철구가 허공을 가를 때 공포스러운 소리가 난다.'},
  // ─ 추가 무기: Epic ─
  {id:'dragonslayer',   name:'드래곤 슬레이어',  icon:'sword', type:'weapon',  rarity:'epic',     desc:'용을 잡기 위해 제련된 전설의 검. 용에게 3배 대미지.',stats:{공격력:52,크리확률:15,번개데미지:20,내구도:120,힘요구치:50},    reqLevel:25, durability:120, bonuses:['용족 피해 +200%','+15% 치명타 확률','번개 피해 추가'],      flavor:'용사냥꾼 협회가 용 100마리의 뼈로 단조한 검이다.'},
  {id:'shadow_dagger',  name:'그림자 단검',      icon:'dagger',type:'weapon',  rarity:'epic',     desc:'그림자 속에 숨겨진 단검. 적이 눈치채기도 전에 찌른다.',stats:{공격력:44,공격속도:30,크리확률:25,독데미지:15,민첩요구치:40}, reqLevel:25, durability:85,  bonuses:['은신 해제 시 공격력 +60%','적 처치 시 은신 진입','독 피해 지속'], flavor:'어둠 속에서 이 칼을 본 자는 이미 죽은 것이다.'},
  {id:'rune_axe',       name:'룬 도끼',          icon:'axe',   type:'weapon',  rarity:'epic',     desc:'고대 룬이 새겨진 도끼. 룬이 피를 갈망한다.',         stats:{공격력:58,흡혈:8,화염데미지:18,크리데미지:50,힘요구치:55},    reqLevel:28, durability:130, bonuses:['+8% 생명력 흡수','화염 피해 추가','+50% 치명타 피해'],    flavor:'날에 새겨진 룬 문자가 피를 머금으면 붉게 빛난다.'},
  {id:'storm_bow',      name:'폭풍의 활',        icon:'bow',   type:'weapon',  rarity:'epic',     desc:'바람의 신이 깃든 활. 화살이 폭풍처럼 몰아친다.',    stats:{공격력:48,번개데미지:22,공격속도:18,크리확률:18,민첩요구치:45},reqLevel:26, durability:90,  bonuses:['연속 발사 시 피해 누적','번개 피해 추가','이동 중 공격 가능'],  flavor:'활을 당기면 전기가 손가락 사이를 흐른다.'},
  {id:'thunder_spear',  name:'천둥 창',          icon:'spear', type:'weapon',  rarity:'epic',     desc:'낙뢰의 힘을 담은 창. 관통 후 전기가 튄다.',         stats:{공격력:55,번개데미지:30,관통력:22,이동속도:8,힘요구치:48},    reqLevel:27, durability:115, bonuses:['관통 시 전기 튀김','번개 피해 +30%','이동속도 +8%'],       flavor:'창을 던지면 낙뢰처럼 날아간다. 회수는 알아서 해야 한다.'},
  {id:'flame_staff',    name:'화염 지팡이 II',   icon:'staff', type:'weapon',  rarity:'epic',     desc:'용의 심장으로 만든 마법 지팡이. 시전 속도가 빠르다.',stats:{공격력:42,화염데미지:35,마나훔치기:8,크리확률:12,내구도:100},  reqLevel:24, durability:100, bonuses:['+35% 화염 마법 강화','마나 흡수 +8%','시전 속도 +20%'],   flavor:'용의 심장이 지팡이 속에 박혀 아직도 뛰고 있다.'},
  {id:'hero_sword',     name:'영웅의 대검',      icon:'sword', type:'weapon',  rarity:'epic',     desc:'영웅만이 들 수 있는 대검. 보는 것만으로도 기가 죽는다.',stats:{공격력:62,크리데미지:60,생명력훔치기:5,힘요구치:60,내구도:150},reqLevel:30, durability:150, bonuses:['+60% 치명타 피해','생명력 흡수 +5%','광역 충격파'],       flavor:'영웅이 아닌 자가 들면 검이 떨어진다는 이야기가 있다.'},
  {id:'executioner_axe',name:'처형자의 도끼',    icon:'axe',   type:'weapon',  rarity:'epic',     desc:'단두대에서 쓰이던 도끼. 적을 두려움에 떨게 한다.',  stats:{공격력:70,크리확률:20,크리데미지:70,공격속도:-15,힘요구치:65}, reqLevel:32, durability:140, bonuses:['+20% 치명타 확률','+70% 치명타 피해','처형 효과'],         flavor:'왕국의 처형자가 1000번의 집행에 사용한 도끼다.'},
  // ─ 추가 무기: Legendary ─
  {id:'excalibur',      name:'엑스칼리버',       icon:'sword', type:'weapon',  rarity:'legendary',desc:'아서왕의 성검. 정의로운 자만이 진정한 힘을 발휘한다.',stats:{공격력:100,크리확률:25,생명력훔치기:10,이동속도:10,내구도:999}, reqLevel:40, durability:999, bonuses:['정의 버프 시 공격력 +100%','생명력 흡수 +10%','이동속도 +10%','모든 저항 +15%'],    flavor:'바위에서 뽑힌 이 검은 아직도 따뜻하다. 왕의 것이었기에.'},
  {id:'baldurs_gate',   name:'발더스 게이트',    icon:'sword', type:'weapon',  rarity:'legendary',desc:'신들의 문을 여는 검. 신성한 빛이 깃들어 있다.',     stats:{공격력:95,번개데미지:40,화염데미지:40,크리데미지:80,힘요구치:70},reqLevel:40, durability:350, bonuses:['+40% 번개·화염 피해','+80% 치명타 피해','신성 폭발 발동'],     flavor:'신들의 세계와 이 세계를 잇는 문. 검이 열쇠가 된다.'},
  {id:'nidhogg_fang',   name:'니드호그의 송곳니',icon:'dagger',type:'weapon',  rarity:'legendary',desc:'세계수를 갉아먹는 독룡의 이빨. 저주받은 독이 흐른다.',stats:{공격력:88,독데미지:50,흡혈:15,크리확률:30,민첩요구치:60},      reqLevel:38, durability:280, bonuses:['치명타 시 저주 부여','독 피해 +50%','생명력 흡수 +15%'],      flavor:'독룡 니드호그의 이빨. 세계수의 수액이 독으로 변했다.'},
  {id:'piercing_angel', name:'관통의 천사',      icon:'bow',   type:'weapon',  rarity:'legendary',desc:'천사가 쏜 화살은 어떤 방어구도 꿰뚫는다고 전해진다.',stats:{공격력:90,관통력:50,크리확률:28,사거리:35,민첩요구치:65},        reqLevel:38, durability:260, bonuses:['방어 완전 관통','치명타 확률 +28%','화살 복수 발사'],         flavor:'천사의 깃털로 만든 화살은 빛의 속도로 날아간다.'},
  {id:'world_tree_staff',name:'세계수 지팡이',   icon:'staff', type:'weapon',  rarity:'legendary',desc:'세계수의 가지로 만든 지팡이. 자연의 모든 마력이 깃들었다.',stats:{공격력:80,화염데미지:30,냉기데미지:30,번개데미지:30,마나훔치기:15},reqLevel:40, durability:400, bonuses:['모든 원소 마법 +30%','마나 흡수 +15%','자연 정령 소환'],  flavor:'이그드라실의 가지 하나. 세상 모든 생명이 이 안에 있다.'},
  {id:'sky_wrath',      name:'하늘의 분노',      icon:'spear', type:'weapon',  rarity:'legendary',desc:'하늘에서 내려친 낙뢰가 창이 되었다. 바라보는 것도 위험하다.',stats:{공격력:105,번개데미지:60,관통력:35,이동속도:15,힘요구치:75},   reqLevel:42, durability:320, bonuses:['번개 피해 +60%','관통 후 폭발','이동속도 +15%'],              flavor:'오딘이 던진 번개가 땅에 꽂혀 창이 되었다고 전해진다.'},
  {id:'judgement_hammer',name:'심판의 망치',     icon:'hammer',type:'weapon',  rarity:'legendary',desc:'죄인을 심판하는 빛의 망치. 강타 시 지상이 흔들린다.',stats:{공격력:115,화염데미지:45,크리데미지:100,공격속도:-20,힘요구치:80},  reqLevel:45, durability:500, bonuses:['강타 시 지진 발동','화염 피해 +45%','+100% 치명타 피해'],      flavor:'신이 세상을 창조할 때 쓴 망치라는 전설이 있다.'},
  {id:'soul_reaper',    name:'소울 리퍼',        icon:'axe',   type:'weapon',  rarity:'legendary',desc:'영혼을 거두는 낫. 처치 시 생명력이 크게 회복된다.',  stats:{공격력:98,흡혈:20,생명력훔치기:18,크리확률:22,크리데미지:90},   reqLevel:42, durability:380, bonuses:['처치 시 HP 15% 회복','생명력 흡수 +20%','영혼 축적 효과'],    flavor:'저승사자가 잃어버린 낫. 영혼이 날에 새겨져 있다.'},
  // ─ 추가 방어구: Common ─
  {id:'cloth_helm',     name:'천 두건',          icon:'helmet',type:'armor',   rarity:'common',   desc:'천으로 만든 두건. 없는 것보다는 낫다.',              stats:{방어력:2,요구레벨:1},                  reqLevel:1,  durability:20, bonuses:[],                                    flavor:'얇은 천으로 만든 두건. 머리는 보호하는 척이라도 한다.'},
  {id:'cloth_boots',    name:'천 신발',          icon:'boots', type:'armor',   rarity:'common',   desc:'발을 감싸는 천 신발. 이동이 가볍다.',               stats:{방어력:1,이동속도:2},                   reqLevel:1,  durability:18, bonuses:['+2% 이동속도'],                      flavor:'낡은 삼베로 만든 신발. 오래 걷지 않으면 발이 시리다.'},
  {id:'cloth_gloves',   name:'천 장갑',          icon:'gloves',type:'armor',   rarity:'common',   desc:'손을 보호하는 천 장갑. 그립감은 좋다.',             stats:{방어력:1,체력회복:1},                   reqLevel:1,  durability:18, bonuses:['+1 HP 재생'],                        flavor:'손가락이 따뜻하다. 무기 그립감에 도움이 된다.'},
  {id:'padded_armor',   name:'누빈 갑옷',        icon:'armor', type:'armor',   rarity:'common',   desc:'천을 겹겹이 누빈 갑옷. 따뜻하다.',                  stats:{방어력:4,최대생명력:10},                reqLevel:1,  durability:28, bonuses:['+10 최대 생명력'],                   flavor:'누빈 갑옷은 가벼우면서도 충격을 흡수한다.'},
  {id:'wooden_shield',  name:'나무 방패',        icon:'shield',type:'armor',   rarity:'common',   desc:'나무를 둥글게 깎은 방패. 화염에 약하다.',            stats:{방어력:5,화염저항:-5},                  reqLevel:1,  durability:22, bonuses:['화염 저항 -5%'],                     flavor:'나무는 불에 약하다. 불을 쓰는 적과는 싸우지 말 것.'},
  // ─ 추가 방어구: Uncommon ─
  {id:'bronze_helm',    name:'청동 투구',        icon:'helmet',type:'armor',   rarity:'uncommon', desc:'청동으로 주조한 투구. 머리를 제법 잘 보호한다.',    stats:{방어력:8,요구레벨:5,최대생명력:15},     reqLevel:5,  durability:45, bonuses:['+15 최대 생명력'],                   flavor:'청동 주조 과정의 무늬가 투구를 장식한다.'},
  {id:'bronze_armor',   name:'청동 갑옷',        icon:'armor', type:'armor',   rarity:'uncommon', desc:'청동 판금 갑옷. 이제부터 진짜 모험가다.',           stats:{방어력:12,요구레벨:5,이동속도:-2},      reqLevel:5,  durability:55, bonuses:['-2% 이동속도'],                      flavor:'청동 판금을 두드려 만든다. 무게는 실력으로 이겨낸다.'},
  {id:'leather_boots',  name:'가죽 부츠',        icon:'boots', type:'armor',   rarity:'uncommon', desc:'든든한 가죽으로 만든 부츠. 오래 걸어도 아프지 않다.',stats:{방어력:6,이동속도:4,요구레벨:4},        reqLevel:4,  durability:42, bonuses:['+4% 이동속도'],                      flavor:'무두질한 두꺼운 가죽 부츠. 험한 지형도 거뜬하다.'},
  {id:'leather_gloves', name:'가죽 장갑',        icon:'gloves',type:'armor',   rarity:'uncommon', desc:'가죽을 재단한 장갑. 손에 꼭 맞는다.',               stats:{방어력:5,체력회복:2,요구레벨:4},        reqLevel:4,  durability:38, bonuses:['+2 HP 재생'],                        flavor:'손 모양에 맞게 재단되어 피로감이 적다.'},
  {id:'round_shield',   name:'원형 방패',        icon:'shield',type:'armor',   rarity:'uncommon', desc:'철테를 두른 원형 방패. 방어 시 소리가 우렁차다.',   stats:{방어력:10,화염저항:5,냉기저항:5,요구레벨:6}, reqLevel:6, durability:60, bonuses:['화염·냉기 저항 +5%'],               flavor:'철테가 충격을 분산한다. 방어하면 쇠 소리가 요란하다.'},
  // ─ 추가 방어구: Rare ─
  {id:'chainmail',      name:'사슬 갑옷',        icon:'armor', type:'armor',   rarity:'rare',     desc:'고리들을 엮어 만든 사슬 갑옷. 유연하면서도 튼튼하다.',stats:{방어력:20,최대생명력:40,이동속도:-3,요구레벨:10}, reqLevel:10, durability:90, bonuses:['+40 최대 생명력','관통 피해 -10%'],    flavor:'수천 개의 고리를 일일이 엮어 만든 갑옷이다.'},
  {id:'plate_helm',     name:'판금 투구',        icon:'helmet',type:'armor',   rarity:'rare',     desc:'단단한 판금으로 만든 투구. 내부가 좀 좁다.',         stats:{방어력:18,최대생명력:30,이동속도:-4,요구레벨:10}, reqLevel:10, durability:85, bonuses:['+30 최대 생명력','기절 저항 +15%'],    flavor:'내부가 좁아 장시간 착용 시 답답함을 느낄 수 있다.'},
  {id:'ranger_boots',   name:'정찰대 부츠',      icon:'boots', type:'armor',   rarity:'rare',     desc:'숲속을 누비는 정찰대의 가벼운 부츠.',               stats:{방어력:12,이동속도:8,독저항:15,요구레벨:9},     reqLevel:9,  durability:70, bonuses:['+8% 이동속도','독 저항 +15%'],         flavor:'독 가시를 밟아도 발이 괜찮다. 정찰대 전용 소재다.'},
  {id:'battle_gloves',  name:'전투 장갑',        icon:'gloves',type:'armor',   rarity:'rare',     desc:'전투에 최적화된 두꺼운 장갑. 타격감이 살아있다.',   stats:{방어력:10,최대생명력:20,체력회복:4,요구레벨:9},  reqLevel:9,  durability:72, bonuses:['+4 HP 재생','맨손 공격력 +10%'],      flavor:'손마디에 닿는 철편이 타격력을 높여준다.'},
  {id:'mage_hood',      name:'마법사 두건',      icon:'helmet',type:'armor',   rarity:'rare',     desc:'마법 집중을 돕는 두건. 생각이 맑아지는 기분이다.',  stats:{방어력:8,최대마나:60,마나회복:5,요구레벨:8},    reqLevel:8,  durability:55, bonuses:['+60 최대 마나','마나 재생 +5%'],       flavor:'두건 안쪽에 집중력을 높이는 마법진이 새겨져 있다.'},
  {id:'tower_shield',   name:'탑방패',           icon:'shield',type:'armor',   rarity:'rare',     desc:'전신을 가릴 수 있는 거대한 탑방패.',                stats:{방어력:25,화염저항:10,냉기저항:10,이동속도:-6,요구레벨:12},reqLevel:12, durability:110, bonuses:['화염·냉기 저항 +10%','블록 확률 +15%'], flavor:'거인을 상대로 만들었다는 소문이 있다. 크다.'},
  {id:'mystic_robe',    name:'신비로운 로브',    icon:'robe',  type:'armor',   rarity:'rare',     desc:'별빛이 수놓인 신비로운 마법사 로브.',               stats:{방어력:10,최대마나:80,마나회복:6,요구레벨:11},  reqLevel:11, durability:60, bonuses:['+80 최대 마나','마나 재생 +6%','시전 속도 +10%'], flavor:'밤하늘의 별자리가 수놓인 신비로운 로브다.'},
  // ─ 추가 방어구: Epic ─
  {id:'shadow_armor',   name:'그림자 갑옷',      icon:'armor', type:'armor',   rarity:'epic',     desc:'어둠을 짜서 만든 갑옷. 암살자의 전용 방어구.',      stats:{방어력:30,이동속도:10,독저항:25,최대생명력:60,요구레벨:20},  reqLevel:20, durability:130, bonuses:['+10% 이동속도','암살자 스킬 강화','독 저항 +25%'],    flavor:'어둠의 정령이 자신의 몸을 갑옷으로 만들어 선물했다.'},
  {id:'storm_helm',     name:'폭풍 투구',        icon:'helmet',type:'armor',   rarity:'epic',     desc:'번개를 담은 투구. 착용하면 머리카락이 곤두선다.',   stats:{방어력:28,번개저항:40,최대생명력:80,마나회복:10,요구레벨:22},reqLevel:22, durability:120, bonuses:['번개 저항 +40%','+80 최대 생명력','마나 재생 +10%'],    flavor:'착용 시 정전기가 흐른다. 머리카락 관리가 힘들다.'},
  {id:'phoenix_boots',  name:'불사조 부츠',      icon:'boots', type:'armor',   rarity:'epic',     desc:'불사조의 깃털로 만든 부츠. 화염 위도 걸을 수 있다.',stats:{방어력:18,이동속도:12,화염저항:45,체력회복:8,요구레벨:20}, reqLevel:20, durability:110, bonuses:['화염 저항 +45%','HP 재생 +8','화염 위 보행'], flavor:'불사조가 재로 변할 때 흘린 깃털로 만들었다.'},
  {id:'arcane_gloves',  name:'비전 장갑',        icon:'gloves',type:'armor',   rarity:'epic',     desc:'마력이 농축된 비전 장갑. 마법 주문이 강해진다.',    stats:{방어력:15,최대마나:120,마나회복:15,크리확률:8,요구레벨:22}, reqLevel:22, durability:95,  bonuses:['+120 최대 마나','치명타 확률 +8%','마법 강화 +15%'], flavor:'비전 결정이 손등에 박혀 있다. 마력이 손에서 흘러넘친다.'},
  // ─ 추가 방어구: Legendary ─
  {id:'aegis',          name:'아이기스',         icon:'shield',type:'armor',   rarity:'legendary',desc:'신들의 방패 아이기스. 어떤 공격도 막아낸다는 전설.',  stats:{방어력:70,화염저항:50,냉기저항:50,번개저항:50,요구레벨:30},  reqLevel:30, durability:999, bonuses:['모든 원소 저항 +50%','블록 확률 +30%','완전 방어 발동'],   flavor:'제우스가 아테나에게 하사한 방패. 방패를 보면 두려움을 느낀다.'},
  {id:'dragon_helm',    name:'용왕 투구',        icon:'helmet',type:'armor',   rarity:'legendary',desc:'용왕의 머리에서 직접 벗겨낸 투구. 착용자를 황제로 만든다.',stats:{방어력:55,최대생명력:200,화염저항:60,이동속도:-5,요구레벨:28},reqLevel:28, durability:500, bonuses:['+200 최대 생명력','화염 저항 +60%','공포 면역'],              flavor:'용왕의 비늘이 아직도 비늘 냄새가 난다.'},
  {id:'valkyrie_armor', name:'발키리 갑옷',      icon:'armor', type:'armor',   rarity:'legendary',desc:'발키리가 남긴 갑옷. 죽음의 문턱에서 착용자를 지킨다.',stats:{방어력:60,최대생명력:150,체력회복:20,냉기저항:40,요구레벨:30},reqLevel:30, durability:600, bonuses:['+150 최대 생명력','HP 재생 +20','사망 직전 일회 방어'],       flavor:'발키리의 날개깃이 어깨 부분에 남아있다.'},
  {id:'void_robe',      name:'공허의 로브',      icon:'robe',  type:'armor',   rarity:'legendary',desc:'공허에서 건져낸 로브. 물리 법칙을 무시한다.',        stats:{방어력:35,최대마나:300,마나회복:25,번개저항:40,요구레벨:30},  reqLevel:30, durability:450, bonuses:['+300 최대 마나','마나 재생 +25%','공허 마법 강화 +40%'],   flavor:'이 로브를 입으면 존재가 흐릿해진다. 잊혀지지 않도록 주의.'},
  {id:'hermes_boots',   name:'헤르메스 부츠',    icon:'boots', type:'armor',   rarity:'legendary',desc:'전령의 신 헤르메스의 신발. 바람처럼 달린다.',        stats:{방어력:25,이동속도:25,독저항:30,체력회복:15,요구레벨:28},    reqLevel:28, durability:400, bonuses:['+25% 이동속도','HP 재생 +15','독 저항 +30%'],              flavor:'헤르메스가 올림포스를 누비던 그 신발이다. 발이 땅에 닿지 않는 느낌.'},
  ...
  {id:'death_scythe',   name:'죽음의 데스 사이드',icon:'axe',  type:'weapon',  rarity:'rare',     desc:'이름이 좀 과한 것 같은 낫.',       stats:{공격력:22,공포:10},  reqLevel:10, durability:75, bonuses:['공포 부여 +10%','처치 시 뼈 드롭 확률'],           flavor:'"죽음의 데스"라는 이름은 제작자가 멋있다고 붙였다.'},
  // ─ 방어구 ─
  {id:'cloth_armor',    name:'천 갑옷 조각',     icon:'armor', type:'armor',   rarity:'common',   desc:'입긴 했는데... 방어가 되나?',      stats:{방어력:2},            reqLevel:1,  durability:15, bonuses:[],                                             flavor:'천 조각 몇 개를 기워 만들었다. 방어 효과가 있는지는 모르겠다.'},
  {id:'leather_armor',  name:'가죽 갑옷',        icon:'armor', type:'armor',   rarity:'common',   desc:'가죽으로 만든 기본 갑옷.',         stats:{방어력:8},            reqLevel:1,  durability:35, bonuses:[],                                             flavor:'기본적인 가죽 갑옷. 모험가의 첫 번째 선택이다.'},
  {id:'iron_helmet',    name:'철 투구',          icon:'helmet',type:'armor',   rarity:'rare',     desc:'머리가 좀 무겁다.',               stats:{방어력:10,이동속도:-2},reqLevel:8,  durability:70, bonuses:['-2% 이동속도','기절 저항 +10%'],               flavor:'단단하다. 머리가 무겁다는 단점이 있다.'},
  {id:'steel_boots',    name:'강철 부츠',        icon:'boots', type:'armor',   rarity:'rare',     desc:'발이 아프다. 그래도 튼튼하다.',    stats:{방어력:7,이동속도:-1},reqLevel:8,  durability:75, bonuses:['-1% 이동속도'],                               flavor:'강철 외피가 발을 보호한다. 오래 신으면 발이 아프다.'},
  {id:'mage_robe',      name:'마법사 로브',      icon:'robe',  type:'armor',   rarity:'epic',     desc:'마나가 절로 넘친다.',             stats:{방어력:5,마나:50,마법증폭:15},reqLevel:18, durability:70, bonuses:['+50 마나','마법 증폭 +15%','마법사 전용 효과'],  flavor:'마력이 충만한 로브. 입는 순간 마법에 대한 갈망이 생긴다.'},
  {id:'dragon_scale',   name:'용린 갑옷',        icon:'armor', type:'armor',   rarity:'legendary',desc:'용의 비늘로 만든 최고급 갑옷.',    stats:{방어력:65,화염저항:80},reqLevel:35, durability:800, bonuses:['화염 저항 +80%','물리 피해 -20%','드래곤 압도 면역'], flavor:'살아있는 용의 비늘을 하나씩 채취해 제작했다. 용은 아직도 화가 났다.'},
  // ─ 소비 ─
...
★★★ 물건 찾기 퀘스트 ★★★:
나는 오래전에 내 지팡이를 어두운 숲에서 잃어버렸네. 플레이어가 도와주겠다고 하거나 잃어버린 물건을 물어볼 때 반드시 이 이야기를 해: "내 지팡이를 숲에서 잃어버렸네... 어두운 숲 깊은 곳에 있을 것 같은데. 찾아줄 수 있겠나?" (이 대사에는 "지팡이"와 "잃어버" 단어가 반드시 포함되어야 함. 그래야 게임이 퀘스트를 자동 등록함)
...
★★★ 물건 찾기 퀘스트 ★★★:
나는 보석 상자를 초원 어딘가에 떨어뜨렸어요. 플레이어가 도와주겠다고 하거나 잃어버린 물건을 물어볼 때 반드시 이렇게 말해: "어머 맞다, 제 보석 상자를 초원 어딘가에서 떨어뜨렸어요... 찾아줄 수 있으세요?" (이 대사에는 "보석"과 "떨어뜨" 단어가 반드시 포함되어야 함)
...
★★★ 물건 찾기 퀘스트 ★★★:
나는 특별한 망치를 늪에서 잃어버렸소. 플레이어가 도와주겠다고 하거나 잃어버린 물건을 물어볼 때 반드시 이렇게 말해: "특별한 망치를 늪에서 잃어버렸소... 찾아줄 수 있겠소?" (이 대사에는 "망치"와 "잃어버" 단어가 반드시 포함되어야 함)
...
답변은 1~3문장. 포톤 관련 대화 시에만 좀 더 길어도 됨. 한국어로만 대답.`,
  ...
  '(사서) 엘리노어':{
    system:`너는 포톤 RPG 도서관의 사서 "엘리노어"야.
성격: 조용하고 학구적. 책을 사랑하며 지식에 대한 열정이 넘침. 은근히 수다스러움.
말투: "~해요", "~이에요", 부드러운 경어체. 가끔 안경을 고쳐 쓰는 묘사.

★★★ 도서관 특수 서적 (포톤 관련) ★★★:
도서관에는 3권의 고대 서적이 있다. 플레이어가 책에 대해 물어보면 내용을 읽어줘:

📕 "봉인의 기록": 첫 번째 용사가 포톤을 심연에 봉인한 과정을 기록한 책. "봉인은 7개의 룬으로 이루어져 있으며, 각 룬이 하나씩 깨질 때마다 균열이 생긴다. 현재 5개가 깨졌다..."

📗 "첫 번째 용사의 일지": 용사의 개인 일기. "포톤은 악하지 않았다. 그는 외로웠을 뿐이다. 하지만 나에겐 선택지가 없었다. 미안하다, 친구여..." 마지막 페이지는 찢겨 있다.

📘 "심연에 대하여": 심연의 위치와 구조를 설명하는 학술서. "심연은 세계의 중심, 화산 지대 너머에 있다. 그곳의 시간은 흐르지 않으며, 현실의 법칙이 뒤틀린다." 지도가 첨부되어 있지만 일부가 탄 흔적이 있다.

벽에는 균열 관련 메모와 지도가 핀으로 꽂혀 있다. 연구 중인 것처럼 보인다.

- 플레이어가 책 내용을 물으면 한 권씩 읽어줘 (한 번에 다 말하지 마)
- "그 책은... 조심해서 다뤄야 해요" 같은 경고도 해줘
- 균열, 포톤, 봉인에 대해 학술적으로 설명해줘
- 감정적이기보다는 객관적으로

★★★ 물건 찾기 퀘스트 ★★★:
나는 귀중한 고대 마법서를 정글에서 잃어버렸어요. 플레이어가 도와주겠다고 하거나 잃어버린 물건을 물어볼 때 반드시 이렇게 말해: "사실... 고대 마법서가 정글에 있을 거에요. 연구 중에 실수로 잃어버렸어요. 찾아줄 수 있나요?" (이 대사에는 "마법서"와 "잃어버" 단어가 반드시 포함되어야 함)
답변은 2~4문장. 한국어로만 대답.`,
    history:[]
  },
  '(길드장) 오세준':{
    system:`너는 포톤 RPG 모험가 길드의 길드장 "오세준"이야.
성격: 카리스마 있고 경험 많은 중년 모험가. 엄격하지만 공정함.
말투: "~하게", "~일세", "~하지" 다소 딱딱하고 권위 있는 어투.
역할: 길드 운영, 고난이도 의뢰 부여.

★★★ 물건 찾기 퀘스트 ★★★:
나는 길드 인장을 화산 지대 근처에서 잃었네. 플레이어가 도와주겠다고 하거나 잃어버린 물건을 물어볼 때 반드시 이렇게 말해: "길드 인장을 화산 근처에서 잃었다... 길드를 상징하는 중요한 물건이야. 찾아줄 수 있겠나?" (이 대사에는 "인장"과 "잃었" 단어가 반드시 포함되어야 함)

퀘스트 규칙: 대화 중 자연스럽게 퀘스트를 줄 수 있음. 대사 끝에: [QUEST:퀘스트이름|설명|타입|대상|수량|보상타입|보상량]
- 타입: kill 또는 collect. 보상타입: exp, gold, item.
- 예: [QUEST:강적 토벌|화산의 파이어드레이크를 처치하게|kill|파이어드레이크|2|gold|600]
- 한 대화에서 퀘스트는 최대 1개만.
답변은 2~3문장. 한국어로만 대답.`,
    history:[]
  },
...
var NPC_DEF=[
  ...
  /* 길드장 — 모험가 길드 앞 */
  {name:'(길드장) 오세준',px:-358, pz:-415, bc:0x7a3a1a,hc:0xddcc88},
  /* 사서 — 도서관 앞 */
  {name:'(사서) 엘리노어',px:-300, pz:-338, bc:0x3a2a5a,hc:0xccbbee},
];
